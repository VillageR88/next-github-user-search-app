...
export default function ButtonTheme() {
  ...
  return (
    <button
      ...
      className={`flex items-center gap-[16px] fill-white pr-2 transition-colors`}
    >
      {theme === Theme.light ? (
        <>
          <span className="text-[13px] font-bold tracking-[2.5px] text-[#697C9A] transition-colors">DARK</span>
          <svg className="transition-colors" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <>
          <span className="text-[13px] font-bold tracking-[2.5px] text-[#FFFFFF] transition-colors">LIGHT</span>
          <svg className="transition-colors" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
